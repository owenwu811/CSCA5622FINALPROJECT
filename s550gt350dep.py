#the goal of this project is to predict the depreciation rate vs. mileage of s550 gt350 mustangs compared to the new prices at 0 mileage from years 2016 - 2020, including both standard and R models
#for example, if I drive my gt350 10,000 miles, how much will that affect depreciation?
#does age vs. mileage impact depreciation more?
import time
import requests
...
def scrape_carfax(year, url):
    ...
    for i, n in enumerate(name):
        ...
        if i < len(carspecs) and i < len(carprice) and i < len(mileage):
